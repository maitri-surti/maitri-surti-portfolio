...
- Try using a tree map instead of a pie chart to make it more intriguing.
- Grey out the 'Private-Nonprofit' and 'Propritery' because are main focus is on Public Schools.
- Add the definition of Loan Originations.
- Include the definition of 'Propritary' School Type.
